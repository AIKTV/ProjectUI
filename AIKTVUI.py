...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton_7.setGeometry(QtCore.QRect(80, 540, 111, 51))
        ...
        self.tubiao1 = QtWidgets.QLineEdit(self.centralwidget)
        self.tubiao1.setGeometry(QtCore.QRect(60, 110, 411, 261))
        self.tubiao1.setAlignment(QtCore.Qt.AlignBottom|QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft)
        self.tubiao1.setObjectName("tubiao1")
        self.tubiao2 = QtWidgets.QLineEdit(self.centralwidget)
        self.tubiao2.setGeometry(QtCore.QRect(660, 110, 411, 261))
        self.tubiao2.setAlignment(QtCore.Qt.AlignBottom|QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft)
        self.tubiao2.setObjectName("tubiao2")
        ...
        self.lineEdit_6.setGeometry(QtCore.QRect(670, 450, 291, 161))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.tubiao1.setText(_translate("MainWindow", "未处理音频文件或录音的声波图"))
        self.tubiao2.setText(_translate("MainWindow", "已处理音频文件或录音的声波图"))
        self.title.setText(_translate("MainWindow", "ai音频信号处理"))
        self.lineEdit_6.setText(_translate("MainWindow", "显示选中模型路径"))
